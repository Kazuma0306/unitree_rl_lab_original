#paper Learning Agile Locomotion on Risky Terrains
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # visualization_markers = VisualizationMarkersCfg(
...
class CommandsCfg:
    ...
    goal_position = mdp.UniformPose2dCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPose2dCommandCfg.Ranges(pos_x=(3.0, 3.5), pos_y=(-1.0, 1.0), heading=(-math.pi/4, math.pi/4)),
    )
...
class RewardsCfg:
    ...
    flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-0.5) #-5.0 for simple walking
